...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0xfe; 0x70; 0xc0; 0xb1]; (* VPSHUFHW (%_% ymm0) (%_% ymm0) (Imm8 (word 177)) *)
 [0xc5; 0xff; 0x70; 0xc0; 0xb1]; (* VPSHUFLW (%_% ymm0) (%_% ymm0) (Imm8 (word 177)) *)
 [0xc5; 0xfe; 0x70; 0xd1; 0xa0]; (* VPSHUFHW (%_% ymm2) (%_% ymm1) (Imm8 (word 160)) *)
 [0xc5; 0xff; 0x70; 0xe3; 0xa0]; (* VPSHUFLW (%_% ymm4) (%_% ymm3) (Imm8 (word 160)) *)
 [0xc4; 0x41; 0x7e; 0x70; 0xf8; 0xff]; (* VPSHUFHW (%_% ymm15) (%_% ymm8) (Imm8 (word 255)) *)
 [0xc4; 0x41; 0x7f; 0x70; 0xc7; 0x1b]; (* VPSHUFLW (%_% ymm8) (%_% ymm15) (Imm8 (word 27)) *)
 [0xc5; 0x7a; 0x70; 0xef; 0x4e]; (* VPSHUFHW (%_% xmm13) (%_% xmm7) (Imm8 (word 78)) *)
 [0xc4; 0x41; 0x7b; 0x70; 0xce; 0xe4]; (* VPSHUFLW (%_% xmm9) (%_% xmm14) (Imm8 (word 228)) *)
 [0xc5; 0xfa; 0x70; 0xda; 0x55]; (* VPSHUFHW (%_% xmm3) (%_% xmm2) (Imm8 (word 85)) *)
 [0xc5; 0xfb; 0x70; 0xf5; 0xaa]; (* VPSHUFLW (%_% xmm6) (%_% xmm5) (Imm8 (word 170)) *)
 [0xc4; 0x41; 0xfe; 0x70; 0xf8; 0xff]; (* VPSHUFHW (%_% ymm15) (%_% ymm8) (Imm8 (word 255)), VEX.W=1 *)
 [0xc4; 0x41; 0xfb; 0x70; 0xc7; 0x00]; (* VPSHUFLW (%_% xmm8) (%_% xmm15) (Imm8 (word 0)), VEX.W=1 *)
 [0xc5; 0xf6; 0x70; 0xc0; 0xb1]; (* Invalid VPSHUFHW encoding: VEX.vvvv is not 1111b *)
 [0xc5; 0xf7; 0x70; 0xc0; 0xb1]; (* Invalid VPSHUFLW encoding: VEX.vvvv is not 1111b *)
 ...
 [0xc4; 0xe2; 0x79; 0x20; 0xc1]; (* vpmovsxbw xmm0, xmm1 *)
 [0xc4; 0x42; 0x79; 0x20; 0xf7]; (* vpmovsxbw xmm14, xmm15 *)
 [0xc4; 0xe2; 0x7d; 0x20; 0xc1]; (* vpmovsxbw ymm0, xmm1 *)
 [0xc4; 0x42; 0x7d; 0x20; 0xf7]; (* vpmovsxbw ymm14, xmm15 *)
 [0xc4; 0xe2; 0xf9; 0x20; 0xc1]; (* vpmovsxbw xmm0, xmm1 [VEX.W=1] *)
 [0xc4; 0xe2; 0xfd; 0x20; 0xc1]; (* vpmovsxbw ymm0, xmm1 [VEX.W=1] *)
 [0xc4; 0xe2; 0x71; 0x20; 0xc1]; (* invalid VPMOVSXBW [VEX.vvvv != 1111] *)
 [0xc4; 0xe2; 0x78; 0x20; 0xc1]; (* invalid VPMOVSXBW [VEX.pp != 01] *)
...
[
  ...
  [0xc4; 0xe2; 0x7d; 0x20; 0x04; 0x24]; (* VPMOVSXBW (%_% ymm0) (Memop Word128 (%% (rsp,0))) *)
  [0xc4; 0x62; 0x7d; 0x20; 0x3c; 0x24]; (* VPMOVSXBW (%_% ymm15) (Memop Word128 (%% (rsp,0))) *)
  [0xc4; 0xe2; 0x79; 0x20; 0x04; 0x24]; (* VPMOVSXBW (%_% xmm0) (Memop Quadword (%% (rsp,0))) *)
  [0xc4; 0x62; 0x79; 0x20; 0x3c; 0x24]; (* VPMOVSXBW (%_% xmm15) (Memop Quadword (%% (rsp,0))) *)
  ...
  [0xc5; 0xfe; 0x70; 0x04; 0x24; 0xb1]; (* VPSHUFHW (%_% ymm0) (Memop Word256 (%% (rsp,0))) (Imm8 (word 177)) *)
  [0xc5; 0x7f; 0x70; 0x54; 0x24; 0x20; 0xa0]; (* VPSHUFLW (%_% ymm10) (Memop Word256 (%% (rsp,32))) (Imm8 (word 160)) *)
  [0xc5; 0xfa; 0x70; 0x5c; 0x24; 0x40; 0x55]; (* VPSHUFHW (%_% xmm3) (Memop Word128 (%% (rsp,64))) (Imm8 (word 85)) *)
  [0xc5; 0x7b; 0x70; 0x64; 0x24; 0x60; 0xaa]; (* VPSHUFLW (%_% xmm12) (Memop Word128 (%% (rsp,96))) (Imm8 (word 170)) *)
